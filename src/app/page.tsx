export default function Home() {
  return (
    <div className="min-h-screen bg-[#f3edf2]">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8 lg:py-20">
        <section className="rounded-[32px] border border-black/10 bg-white px-6 py-10 shadow-sm transition duration-300 hover:shadow-md sm:px-10 sm:py-14 lg:px-14 lg:py-16">
          <div className="max-w-4xl">
            <p className="mb-4 text-sm font-medium tracking-tight text-black/60">
              Wanky
            </p>

            <h1 className="max-w-4xl text-4xl font-semibold leading-[0.95] tracking-[-0.05em] text-black sm:text-5xl lg:text-7xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <a
                href="/contact"
                className="inline-flex items-center justify-center rounded-full border border-black/10 bg-black px-6 py-3 text-sm font-medium text-white transition duration-300 hover:-translate-y-0.5 hover:opacity-90 hover:shadow-md"
              >
                Talk to us
              </a>
            </div>
        ...
        <section className="mt-10 grid gap-5 md:grid-cols-3">
          <div className="rounded-[24px] border border-black/10 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
        ...
        <section className="mt-10 rounded-[32px] border border-black/10 bg-white px-6 py-8 shadow-sm transition duration-300 hover:shadow-md sm:px-10 sm:py-10">
        ...
        <section className="mt-10 grid gap-5 lg:grid-cols-2">
          <div className="rounded-[32px] border border-black/10 bg-white px-6 py-8 shadow-sm transition duration-300 hover:shadow-md sm:px-10">
            <h2 className="text-2xl font-semibold tracking-tight text-black">
              Projects
            </h2>
            <div className="mt-5 rounded-[24px] border border-black/10 bg-black/[0.02] p-5 transition duration-300 hover:-translate-y-1 hover:shadow-md">
          ...
          <div className="rounded-[32px] border border-black/10 bg-white px-6 py-8 shadow-sm transition duration-300 hover:shadow-md sm:px-10">
            ...
            <a
              ...
              className="mt-6 inline-flex rounded-full border border-black px-5 py-3 text-sm font-medium text-black transition duration-300 hover:-translate-y-0.5 hover:bg-black hover:text-white hover:shadow-md"
            >
